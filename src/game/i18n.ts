...
const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    'game.share.open': 'Share',
    'game.share.title': 'Share Bobby',
    'game.share.close': 'Close share card',
    'game.share.loading': 'Generating card...',
    'game.share.ready': 'Card ready. Save it or long-press on mobile.',
    'game.share.error': 'Card could not be generated',
    'game.share.save': 'Save Image',
    'game.share.native': 'Share...',
    'game.share.mobileHint': 'On mobile, long-press the card image to save it locally.',
    'game.share.imageAlt': 'Generated Bobby Carrot share card with a QR code',
    'game.share.cardTitle': 'Bobby Carrot',
    'game.share.cardSubtitle': 'A tiny maze adventure with carrots, traps, and one stubborn rabbit.',
    'game.share.cardLevel': 'Level 6 Preview',
    'game.share.cardMeta': '24 carrots in a trap garden',
    'game.share.cardCta': 'Scan to play',
    'game.share.cardFooter': 'Built for quick puzzle runs on desktop and mobile.',
    'game.share.level6': 'Level 6',
    'game.share.scan': 'SCAN TO PLAY',
  ...
  zh: {
    ...
    'game.share.open': '分享',
    'game.share.title': '分享 Bobby',
    'game.share.close': '关闭分享卡片',
    'game.share.loading': '正在生成卡片...',
    'game.share.ready': '卡片已生成，可保存图片；移动端可长按保存。',
    'game.share.error': '卡片生成失败',
    'game.share.save': '保存图片',
    'game.share.native': '系统分享',
    'game.share.mobileHint': '移动端可以长按卡片图片，保存到本地相册。',
    'game.share.imageAlt': '带二维码的 Bobby Carrot 分享卡片',
    'game.share.cardTitle': 'Bobby 胡萝卜',
    'game.share.cardSubtitle': '一只兔子的迷宫冒险，收集胡萝卜，绕开陷阱。',
    'game.share.cardLevel': '第 6 关预览',
    'game.share.cardMeta': '24 根胡萝卜 · 陷阱花园',
    'game.share.cardCta': '扫码开玩',
    'game.share.cardFooter': '桌面和手机都能玩的轻量解谜小游戏。',
    'game.share.level6': '第 6 关',
    'game.share.scan': '扫码开玩',
